...
export const metadata: Metadata = {
  ...
  description:
    "Understand how Footloose Edwin's Dance Company collects, stores, and protects your information.",
};
...
const sections = [
  ...
  },
  {
    title: "Your choices",
    body: [
      "Request access to, correction of, or deletion of your personal data by emailing admin@footloose.online.",
  ...
  },
  {
    title: "Contact",
    body: [
      "For privacy questions, email admin@footloose.online or write to Footloose Studio, Chennai, Tamil Nadu, India.",
    ],
  },
];
