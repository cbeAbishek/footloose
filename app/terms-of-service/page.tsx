...
export const metadata: Metadata = {
    ...
    description: "Review the Footloose Edwin's Dance Company terms governing service engagements and site usage.",
}
...
const terms = [
    ...
    },
    {
        title: "Contact",
        body: [
            "For questions regarding these terms, email legal@footloose.online or write to Footloose Studio, Chennai, Tamil Nadu, India.",
        ],
    },
]
    ...
    return (
        <Container className="space-y-12 py-16">
            <div className="space-y-3">
                <p className="text-xs uppercase tracking-[0.3em] text-foreground/60">Terms</p>
                <h1 className="text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">
                    Terms of service
                </h1>
                <p className="text-sm text-foreground/60">Effective date: {new Date().getFullYear()}</p>
            </div>
