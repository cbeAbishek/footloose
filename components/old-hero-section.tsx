        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300 text-pretty leading-relaxed max-w-2xl animate-fade-in-up animation-delay-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 animate-fade-in-up animation-delay-400">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center space-x-3 text-sm group hover:scale-105 transition-all duration-300 cursor-pointer"
                >
            ...
            {/* Social Proof */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-8 text-sm text-gray-400 animate-fade-in-up animation-delay-800">
          ...
          <div className="relative animate-fade-in-right">
            {/* Main Dance Stage */}
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden bg-gradient-to-br from-purple-900/30 via-blue-900/20 to-teal-900/30 backdrop-blur-sm shadow-2xl border border-white/10 group cursor-pointer">
              {/* Dance Floor Grid */}
              <div className="absolute inset-0 opacity-20">
                <div className="w-full h-full grid grid-cols-8 grid-rows-6 gap-1 p-4">
                  {[...Array(48)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-white/10 rounded-sm animate-dance-floor-pulse"
                      style={{
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {/* Dancer 1 */}
                <div className="absolute left-1/4 top-1/3 animate-dancer-spin">
                  <div className="relative">
                    <div className="w-6 h-6 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full animate-bounce-dance"></div>
                    <div className="w-1 h-8 bg-gradient-to-b from-purple-400 to-transparent mx-auto animate-sway"></div>
                    <div className="flex justify-center space-x-2 animate-leg-dance">
                      <div className="w-0.5 h-4 bg-purple-400 rotate-12 animate-kick-left"></div>
                      <div className="w-0.5 h-4 bg-purple-400 -rotate-12 animate-kick-right"></div>
                    </div>
                  </div>
                </div>

                {/* Dancer 2 */}
                <div className="absolute right-1/4 top-1/2 animate-dancer-groove">
                  <div className="relative">
                    <div className="w-6 h-6 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full animate-head-bob"></div>
                    <div className="w-1 h-8 bg-gradient-to-b from-blue-400 to-transparent mx-auto animate-body-wave"></div>
                    <div className="flex justify-center space-x-2">
                      <div className="w-0.5 h-4 bg-blue-400 animate-step-left"></div>
                      <div className="w-0.5 h-4 bg-blue-400 animate-step-right"></div>
                    </div>
                  </div>
                </div>

                {/* Dancer 3 */}
                <div className="absolute left-1/2 bottom-1/3 animate-dancer-twist">
                  <div className="relative">
                    <div className="w-6 h-6 bg-gradient-to-br from-teal-400 to-green-400 rounded-full animate-spin-head"></div>
                    <div className="w-1 h-8 bg-gradient-to-b from-teal-400 to-transparent mx-auto animate-twist-body"></div>
                    <div className="flex justify-center space-x-2">
                      <div className="w-0.5 h-4 bg-teal-400 animate-slide-left"></div>
                      <div className="w-0.5 h-4 bg-teal-400 animate-slide-right"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute inset-0 pointer-events-none">
                {[...Array(8)].map((_, i) => (
                  <div
                    key={i}
                    className="absolute text-2xl animate-musical-float"
                    style={{
                      left: `${20 + i * 10}%`,
                      top: `${10 + (i % 3) * 30}%`,
              ...
              <div
                className="absolute w-32 h-32 bg-gradient-radial from-yellow-400/30 to-transparent rounded-full animate-spotlight transition-all duration-500"
                style={{
                  left: `${25 + Math.sin(Date.now() / 2000) * 25}%`,
                  top: `${25 + Math.cos(Date.now() / 1500) * 25}%`,
                }}
              />

              {/* Dance Studio Mirror Effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent animate-mirror-shine"></div>
            ...
            {/* Floating Dance Stats */}
            <div className="absolute -top-6 -right-6 bg-gray-900/80 backdrop-blur-lg border border-white/20 rounded-xl p-4 shadow-2xl animate-dance-bounce hover:scale-105 transition-transform duration-300">
              <div className="flex items-center space-x-3 text-sm">
                <div className="relative">
                  <div className="h-3 w-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 animate-pulse-rhythm"></div>
                  <div className="absolute inset-0 h-3 w-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 animate-ping"></div>
                </div>
                <span className="font-medium text-white animate-text-dance">
                  Live Beat Active
                </span>
              </div>
            </div>

            {/* Dance Experience Counter */}
            <div className="absolute -bottom-6 -left-6 bg-gradient-to-br from-purple-600 to-blue-600 text-white rounded-xl p-6 shadow-2xl animate-counter-dance hover:scale-105 transition-transform duration-300">
              <div className="text-center">
                <div className="text-3xl font-bold animate-number-bounce">
                  30+
                </div>
                <div className="text-sm opacity-90 animate-text-sway">
                  Years Dancing
                </div>
              </div>
            </div>
            ...
            <div className="absolute -z-10 -top-20 -right-20 w-40 h-40 border-2 border-purple-500/20 rounded-full animate-choreography-circle"></div>
            <div className="absolute -z-10 -bottom-20 -left-20 w-32 h-32 border-2 border-pink-500/20 rounded-full animate-choreography-circle-reverse"></div>
            ...
            <div className="absolute -z-10 inset-0">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="absolute w-4 h-6 bg-gradient-to-t from-cyan-400/30 to-transparent rounded-full animate-dance-steps"
                  style={{
                    left: `${20 + i * 12}%`,
                    bottom: "10%",
