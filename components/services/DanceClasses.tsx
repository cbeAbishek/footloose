...
export function DanceClasses() {
  const data = servicesData.danceClasses
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full bg-white text-black hover:bg-gray-100 dark:bg-white dark:text-black"
                >
                  <a href="#enroll">{data.cta}</a>
                </Button>
                <Button
                  asChild
                  variant="outline"
      ...
      {/* Enrollment Form */}
      <section id="enroll" className="scroll-mt-20 py-16 sm:py-24">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300 dark:text-gray-700">
              Join thousands of students who've discovered their passion for dance with us
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              >
                <a href="tel:+919842222467">Call Us Now</a>
              </Button>
              <Button
                asChild
                variant="outline"
              ...
              >
                <Link href="/contact">
                  Visit Our Studio <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </div>
          </motion.div>
