...
export const sampleTestimonials: AlumniTestimonial[] = [
  {
    ...
    content:
      "Edwin's Dance Company gave me more than technique — it gave me a family. The foundation I built here launched my international career. Every time I choreograph, I carry the values of discipline, creativity, and community that Edwin instilled in us.",
  ...
  },
  {
    ...
    content:
      "The precision and attention to detail I learned at Footloose became my signature style. From student showcases to Singapore runways, the journey has been incredible. Edwin's mentorship shaped not just my dancing, but my entire approach to creative direction.",
  ...
  },
  {
    ...
    content:
      "Chair-Co-Cise changed my life trajectory. What started as a wellness class became my life's mission. Today, I'm helping thousands of people discover the healing power of movement, thanks to the foundation Edwin's team built.",
...
export const sampleEvents: AlumniEvent[] = [
  {
    ...
    description:
      "Join fellow Footloose alumni from around the world for a weekend of performances, workshops, and reconnection. Special performances by featured alumni and collaborative choreography sessions.",
  ...
  },
  {
    ...
    description:
      "Monthly virtual masterclasses led by successful alumni. Share your expertise, inspire current students, and stay connected with the Footloose community.",
  ...
  },
  {
    ...
    description:
      "Celebrate two decades of dance excellence with performances spanning every era. Alumni showcase, documentary screening, and special awards ceremony.",
...
export const sampleOpportunities: AlumniOpportunity[] = [
  {
    ...
    type: "teaching",
    description:
      "We're looking for passionate alumni to teach our growing kids program. Focus on Western and Bollywood styles for ages 6-12.",
    organization: "Edwin's Dance Company",
    location: "Coimbatore, India",
    posted_date: "2024-11-01T00:00:00Z",
    deadline: "2024-12-01T00:00:00Z",
    contact_email: "event@footloose.online",
    is_active: true,
  },
  {
    id: "2",
    ...
    type: "collaboration",
    description:
      "Seeking experienced choreographer for large-scale corporate annual day. 500+ performers, mix of traditional and contemporary.",
  ...
  },
  {
    ...
    type: "job",
    description:
      "Full-time position creating dance tutorial content for digital platform. Looking for someone with social media experience and teaching skills.",
...
export const sampleAwards: AlumniAward[] = [
  {
    ...
    description:
      "Recognized for outstanding contribution to contemporary Indian dance and innovative fusion choreography.",
    year: 2022,
  ...
  },
  {
    ...
    description:
      "Excellence in movement direction for fashion and commercial arts.",
    year: 2023,
  },
  {
    id: "3",
    ...
    description:
      "Pioneering work in dance therapy and special needs education.",
    year: 2023,
